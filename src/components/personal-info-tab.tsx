  ...
  return (
    <Card className="w-full bg-card border border-border shadow-lg hover:shadow-xl transition-shadow duration-300 overflow-hidden">
      ...
      <CardHeader className="text-center pt-8 animate-fade-in" style={{ animationDelay: '0.1s' }}>
        <Avatar className="mx-auto h-24 w-24 mb-4 ring-2 ring-primary ring-offset-4 ring-offset-background transform transition-transform duration-300 hover:scale-105 animate-fade-in" style={{ animationDelay: '0.2s' }}> {/* Delay avatar slightly more */}
          <AvatarImage src="https://picsum.photos/200/200" alt="Profile Picture" data-ai-hint="person profile" />
          <AvatarFallback>JD</AvatarFallback>
        </Avatar>
        <CardTitle className="text-3xl font-semibold animate-fade-in" style={{ animationDelay: '0.3s' }}>John Doe</CardTitle>
        <p className="text-primary font-medium animate-fade-in" style={{ animationDelay: '0.4s' }}>Software Engineer</p>
      </CardHeader>
       {/* Apply animation class directly to content elements */}
      <CardContent className="space-y-6 text-center pb-8">
        <p className="text-muted-foreground leading-relaxed max-w-xl mx-auto animate-fade-in" style={{ animationDelay: '0.5s' }}>
        ...
        <div className="flex items-center justify-center space-x-2 text-muted-foreground animate-fade-in" style={{ animationDelay: '0.6s' }}>
          <MapPin className="h-4 w-4" />
          <span>San Francisco, CA</span>
        </div>
         <div className="flex justify-center space-x-4 pt-4 animate-fade-in" style={{ animationDelay: '0.7s' }}>
