...
// WhatsApp SVG component (reuse if needed, or import from a shared utility)
const WhatsAppIcon = () => (
...
export default function HeroSection({ personalInfo }: HeroSectionProps) {
  return (
    <div className="z-10 flex flex-col items-center animate-fade-in-up">
      ...
      <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-2xl text-center">
         {personalInfo.title} {/* Or a more concise tagline */}
         <br /> {/* Optional: Add a short sentence from the objective */}
         Passionate about VLSI technology and contributing to India's semiconductor growth.
      </p>
